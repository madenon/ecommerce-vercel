        ...
        {loading ? (
          loadingList.map((product, index) => {
            return (
              ...
              >
                <div className="bg-slate-200  h-48 p-4   minw-[280px] md:min-w-[145px] flex justify-center items-center animate-pulse">
                ...
                <div className="p-4 grid gap-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <p className="text-slate-500 line-through p-1  animate-pulse rounded-full bg-slate-200 w-ful py-2l">
                  </p>
            ...
            return (
              ...
              >
                ...
                <div className="p-4 grid gap-3">
                  ...
                  <button className="text-sm flex  w-40 ml-16 bg-purple-600 hover:bg-purple-700 text-white px-3 py-0.5 rounded-full" onClick={(e)=>handleAddToCart(e,product._id)}>
                    Ajouter au panier
                  </button>
                </div>
              </Link>
