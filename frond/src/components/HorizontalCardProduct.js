          ...
          loading? (
            loadingList.map((product, index) => {
              return (
                ...
                >
                  <div className="bg-slate-200 h-full p-4 minw-[120px] md:min-w-[145px]  animate-pulse">
                  ...
                  <div className="p-4 grid w-full gap-2">
                    ...
                    <p className="text-red-600 font-medium bg-slate-200 w-full  animate-pulse rounded-full">
                    </p>
                    ...
                    <button className="text-sm text-white w-full px-3 py-0.5 rounded-full  bg-slate-200  animate-pulse">
                    </button>
                  </div>
                </div>
              );
